...
function preCheck(min, max) {

  if ((min < 4 || min > 35 ||max < 4 || max > 35) && console_temperature === celsius) {
    ...
    else if ((min <  39 || min >  95 ||max <  39 || max >  95) && console_temperature === farenheit) {
